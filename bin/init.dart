...
String _classTemplate(String className, {required bool isFlutterProject}) {
  if (isFlutterProject && _isColorClass(className)) {
    return "import 'package:flutter/material.dart';\n"
        ...
        '  const $className._();\n'
        '\n'
        '  // You can keep each token as int OR Color.\n'
        '  static const Object _primaryToken = 0xFF6200EE;\n'
        '  static const Object _primaryVariantToken = 0xFF3700B3;\n'
        '  static const Object _secondaryToken = 0xFF03DAC6;\n'
        '  static const Object _secondaryVariantToken = 0xFF018786;\n'
        '  static const Object _onErrorToken = 0xFFFFFFFF;\n'
        '  static const Object _textToken = Color(0xFF000000);\n'
        '  static const Object _overlayToken = Color.fromARGB(5, 2, 4, 5);\n'
        '\n'
        '  // Public API is always Color, so Flutter widgets accept it directly.\n'
        '  static Color get primary => colorOf(_primaryToken);\n'
        '  static Color get primaryVariant => colorOf(_primaryVariantToken);\n'
        '  static Color get secondary => colorOf(_secondaryToken);\n'
        '  static Color get secondaryVariant => colorOf(_secondaryVariantToken);\n'
        '  static Color get onError => colorOf(_onErrorToken);\n'
        '  static Color get text => colorOf(_textToken);\n'
        '  static Color get overlay => colorOf(_overlayToken);\n'
        '\n'
